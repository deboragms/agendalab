...
<head>
    ...
    <title>Consultar Feriados</title>
</head>
        ...
        <div class="content-box">
            ...
            <form action="" method="post">
                ...
                <div class="button-group">
                    ...
                    <a href="ferinsert.php" class="custom-btn btn-link-custom">
                        Incluir
                    </a>
                </div>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td class="operation-buttons">
                                        ...
                                        <a href="ferupdate.php?updateid=' . $row['id'] . '" 
                                           class="btn btn-success btn-sm">
                                           Alterar
                                        </a>

                                        <a href="ferdelete.php?deleteid=' . $row['id'] . '" 
